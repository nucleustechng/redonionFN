              ...
              {checkStatus === 0 ? (
                <>
                  ...
                  <Typography
                    ...
                    textAlign={'center'}
                  >
                   Use an authentication app such as Google Authenticator, Microsoft Authenticator or Authy 
                   to scan this QR Code. Alternatively, you can set up on the same device or enter the code 
                   provided below 


                  </Typography>
                  <Box >
                    <Box mt={-3} mb={3} height={300} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', background: "#fff" }} >
                      <LazyImageComponent style={{ width: "300px"}} src={userAuth?.qrCode} />
                    </Box>
                      ...
                      <a
                        target="_blank"
                      href={userAuth?.url}
                        style={{ textDecoration: "none", fontSize: 16,  color: "#3063E9", textTransform: "none", marginTop: "0", }}
                      >
                    ...
                    <Typography
                      ...
                      textAlign={'center'}
                    >
                      Alternatively, enter this code into your authentication app
